...
// jesus_holds_man.jpg  → Jesus holding the broken man at the cross
// man_in_fire.png      → silhouette walking into golden fire
    ...
    <GhostWrapper file="src/pages/Landing.tsx">
      <div style={{
        ...
        <div style={{
          ...
          <img
            src="/images/jesus_holds_man.jpg"
            alt=""
            style={{
              width: '100%',
              height: '100%',
